...
import pe.edu.upc.prime.platform.payment.service.interfaces.rest.controllers.PaymentsController;
...
/**
 * Exception handler for Payment-related controllers.
 */
...
public class PaymentExceptionHandler {
    ...
    public ResponseEntity<BadRequestResponse> handleJsonParseError(HttpMessageNotReadableException ex) {
        ...
        if (cause instanceof InvalidFormatException ife) {
            ...
            if (ife.getTargetType().equals(CardType.class)) {
                fieldErrors.put("cardType", "Invalid cardType '" + ife.getValue()
