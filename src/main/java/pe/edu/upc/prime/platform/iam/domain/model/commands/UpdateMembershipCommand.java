 ...
 *
 * @param idMembership the identifier of the membership to be updated
 ...
 */
public record UpdateMembershipCommand(String idMembership, MembershipDescription membershipDescription,
                                      LocalDate started, LocalDate over) {
    public UpdateMembershipCommand {
        Objects.requireNonNull(idMembership, "[UpdateMembershipCommand] id membership must not be null");
