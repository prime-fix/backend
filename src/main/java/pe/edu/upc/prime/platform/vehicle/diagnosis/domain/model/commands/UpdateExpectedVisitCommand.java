 ...
 */
public record UpdateExpectedVisitCommand(Long expectedVisitId, StateVisit stateVisit, VisitId visitId, Boolean isScheduled, VehicleId vehicleId) {
    public UpdateExpectedVisitCommand {
        ...
        Objects.requireNonNull(vehicleId, "[UpdateExpectedVisitCommand] vehicle id must not be null");
