 ...
 *
 * @param idNotification the unique identifier of the notification to be created
 ...
 */
public record CreateNotificationCommand(String idNotification, String message, boolean read,
                                        String idVehicle, LocalDate sent, String idDiagnostic) {

    public CreateNotificationCommand {
        Objects.requireNonNull(idNotification, "[CreateNotificationCommand] id notification must not be null");
