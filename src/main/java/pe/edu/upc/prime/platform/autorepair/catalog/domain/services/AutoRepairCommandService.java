...
public interface AutoRepairCommandService {
    ...
    /**
     * Handle a service to AutoRepair command
     * @param command The delete service to AutoRepair Service catalog command containing the service id
     */
    void handle(DeleteServiceToAutoRepairServiceCatalogCommand command);
}
