...
public class TechnicianDeletedDomainEventHandler {
     ...
     */
    public TechnicianDeletedDomainEventHandler(AutoRepairQueryService autoRepairQueryService) {
    ...
    public void on(TechnicianDeletedEvent event) {
        ...
        if (optionalAutoRepair.isPresent()) {
            ...
            LOGGER.info("Technician deleted for Auto Repair ID {}:", event.getAutoRepairId());
