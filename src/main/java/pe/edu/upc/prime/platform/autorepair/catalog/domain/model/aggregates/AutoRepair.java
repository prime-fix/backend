...
public class AutoRepair extends AuditableAbstractAggregateRoot<AutoRepair> {
     ...
     */
    public void registerNewOffer(Service service, BigDecimal price, Boolean is_active, int duration_hour){
        this.serviceCatalog.addServiceOffer(this,service,price, is_active, duration_hour);
    }

    /**
     * Remover Service Offer
     * @param service the services
     */
    public void removeOffer(Service service){
        this.serviceCatalog.removeServiceOffer(this,service);
    }
